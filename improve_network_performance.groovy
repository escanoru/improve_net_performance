def setDescription() { 
  ...
  item.setDescription("<h5><span style=\"color:green\">This jobs performs some adjustments on the /etc/sysctl.conf file in order to improve the network peformance<ol><li>net.core.wmem_max = 209715200</li><li>net.core.rmem_max = 209715200</li><li>net.ipv4.tcp_rmem = 5242880 10485760</li><li>net.ipv4.tcp_wmem = 5242880 10485760</li><li>net.ipv4.tcp_window_scaling = 1</li><li>net.ipv4.tcp_timestamps = 0</li><li>net.ipv4.tcp_sack = 0</li><li>net.ipv4.tcp_dsack = 0</li><li>net.ipv4.tcp_no_metrics_save = 1</li><li>net.core.netdev_max_backlog = 10000</li></ol></span></h5>") 
  item.save()
  }
setDescription()
